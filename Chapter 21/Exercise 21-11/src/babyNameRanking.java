  ...
  public void findRanking( ) {
	  ...
	  if(gender.equalsIgnoreCase("male")) {
		  if (mapForBoy[year - 2001].containsKey(name)) {
			  lblResult.setText("Boy name " + name + " is ranked #" + mapForBoy[year - 2001].get(name) + " in the year " + year);
		  }
		  else {
			  lblResult.setText("The name " + name + " does not exist at this time.");
		  }
	  }
	  else {
		  if (mapForGirl[year - 2001].containsKey(name)) {
			  lblResult.setText("Girl name " + name + " is ranked #" + mapForGirl[year - 2001].get(name) + " in the year " + year);
		  }
		  else {
			  lblResult.setText("The name " + name + " does not exist at this time.");
		  }
